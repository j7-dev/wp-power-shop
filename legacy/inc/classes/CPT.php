...
final class CPT {
	...
	public function limit_css_and_js() {
		if ( $this->iel ) {
			...
			\wp_enqueue_style( 'jquery-confirm', Plugin::$url . '/legacy/inc/assets/packages/jquery-confirm/jquery-confirm.min.css' );
			\wp_enqueue_script( 'jquery-confirm', Plugin::$url . '/legacy/inc/assets/packages/jquery-confirm/jquery-confirm.min.js', [ 'jquery' ], '3.3.4', true );
			\wp_enqueue_script( self::CPT_SLUG, Plugin::$url . '/legacy/inc/assets/js/main.js', [ 'jquery-confirm' ], Plugin::$version, true );
			wp_localize_script(
				self::CPT_SLUG,
				'powerShopData',
				[
