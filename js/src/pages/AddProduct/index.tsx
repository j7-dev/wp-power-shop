...
export const tinyMCESaveBtn = document.getElementById(
	'publish',
) as HTMLInputElement | null // 因為發布與更新的 按鈕不同
export const blockEditorSaveBtn = document.querySelector(
	'[class*="editor-post-publish-button"]',
) as HTMLInputElement | null
export const fieldNode = document.getElementById(
	`meta-${metaId}-value`,
) as HTMLInputElement | null
...
const AddProduct = () => {
	...
	return (
		<div className="p-4">
			{(isPSMetaLoading ||
				isHandleShopMetaLoading ||
				productsResult.isLoading) && <LoadingWrap />}
			<Form
				className="pt-4"
				layout="vertical"
				form={form}
