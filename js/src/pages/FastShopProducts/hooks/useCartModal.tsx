...
const useCartModal = () => {
  ...
  const renderCartModal = () => {
    switch (type) {
      case 'simple':
        return <SimpleModal product={product} modalProps={defaultModalProps} FSMeta={FSMeta} />
      case 'variable':
        return <VariableModal product={product} modalProps={defaultModalProps} FSMeta={FSMeta} />
      default:
        return <SimpleModal product={product} modalProps={defaultModalProps} FSMeta={FSMeta} />
    }
  }
