		...
		<form class="pt-24 w-fit mx-auto" method="post"
			...
			<div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8 z-50 relative">
				...
				<input type="hidden" name="action" value="PowerShop_el_deactivate_license" />
					...
					?>
					<p class='text-gray-500'>請輸入授權碼以開通進階功能，購買授權請到<a target="_blank" class="font-semibold leading-6 text-primary hover:text-primary-400" href="<?php echo Bootstrap::BUY_LICENSE_LINK; ?>">站長路可網站</a>購買
					有任何客服問題，請私訊站長路可網站右下方對話框，或是來信 <a href="mailto:<?php echo Bootstrap::SUPPORT_EMAIL; ?>" target="_blank" class="font-semibold leading-6 text-primary hover:text-primary-400">
						<?php echo Bootstrap::SUPPORT_EMAIL; ?>
					</a></p>
				</div>
					...
					<table class="table table-fixed table-small th-left">
						<tbody>
							...
							<tr>
								...
								<td>
									<?php
									echo \esc_html( $this->response_obj->expire_date, 'power-shop' );
