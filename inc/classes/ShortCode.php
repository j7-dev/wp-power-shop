	...
	public function products_shortcode_callback(): string {
		...
		<?php if ( ! $enable_virtual_list ) : ?>
			...
			foreach ( $handled_shop_meta as $meta ) {
				...
				$default_image_src = Plugin::$url . '/js/src/assets/images/defaultImage.jpg';
				switch ( $product_type ) {
					case 'variable':
						\load_template(
							Plugin::$dir . '/inc/templates/single-product/variable.php',
							false,
							[
								'product'           => $product,
								'meta'              => $meta,
					...
					case 'simple':
						\load_template(
							Plugin::$dir . '/inc/templates/single-product/simple.php',
							false,
							[
								'product'           => $product,
								'meta'              => $meta,
